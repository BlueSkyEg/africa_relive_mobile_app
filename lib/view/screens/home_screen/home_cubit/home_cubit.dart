...
import 'dart:async';
import 'dart:convert';
import 'package:africa_relief/models/payment_models/retrieve_all_payment_model.dart';
...
class HomeCubit extends Cubit<HomeStates> {
  ...
  List<ProjectsData> projects = [
    ProjectsData(
      ...
      description:
          'In Africa, where knowledge is power, 20% lack formal schooling, while 28% completed primary, 37% secondary, and 15% higher education, these statistics highligh the importance of accessible learning opportunities',
      image:
          'https://africa-relief.org/wp-content/uploads/2023/11/image-3-2.webp',
      body1:
          'In Africa, the pursuit of education remains pivotal, with staggering statistics showing that one in five adults lacks formal education. ARCD’s Relief champions start the change through Educational Centers, bridging this gap by providing accessible and quality education. These centers serve as catalysts for transformation, nurturing young minds, and illuminating paths to a brighter future.',
      header1: 'Educational Centers, where minds flourish and futures bloom',
      body2:
          'ARCD’s Relief is committed to breaking barriers by establishing Educational Centers across communities in Africa. These centers are not just buildings; they’re havens of knowledge and hope, offering educational opportunities to those who’ve been marginalized',
      header2: 'How is ARCD\'s Relief responding?',
      body3:
          'In the heart of every Educational Center lies the seed of change, nurturing minds and fostering brighter tomorrows.Your support propels , enabling education for all and fostering a more empowered, educated Africa.',
      header3: 'Education: Building Bridges, Transforming Lives',
      amounts: [690, 920, 1150, 27600],
    ),
    ProjectsData(
      id: 2,
      type: 'Water',
      ...
      description:
          'Provide easy access to clean water for the vilage, supports 200-400 individuals. These wells sustain livelihoods, ensuring a continuous flow of clean water for those in need.',
      image:
          'https://africa-relief.org/wp-content/uploads/2023/11/unnamed_2-1.webp',
      body1:
          'Sub-Saharan Africa grapples with a staggering 40% of its population—approximately 783 million people—deprived of clean drinking water. In this context, each surface well acts as a beacon of hope, serving not only as a source of life but also as a vital lifeline for those lacking access, offering a means to quench the thirst and preserve the lives of many.',
      header1:
          'Each well stands as a paving the way for healthier, thriving livelihoods.',
      body2:
          'ARCD’s Relief establishes surface water wells, utilizing natural resources to create accessible water sources for communities in need.',
      header2: 'How is ARCD\'s Relief responding?',
    ...
    ProjectsData(
      ...
      title: 'Food Basket',
      description:
          'Let’s Unite to Ensure No Neighbor Goes Hungry. In Africa, Two-Thirds Struggle with Food Insecurity. Your Donation Fights Hunger. Join Us to Create a Lasting Impact!',
      image:
          'https://africa-relief.org/wp-content/uploads/2023/11/image-12.webp',
      body1:
      ...
      header1:
          'All faiths converge on a singular cause: alleviating hunger through compassionate contributions',
      body2:
          'ARCD’s Relief acts swiftly, addressing hunger through our Food Basket Project, offering vital nourishment to those in need. Your donations fuel this initiative, transforming compassion into instant relief. Join hands with us to directly impact and contribute to our mission of eradicating hunger.',
      header2: 'How is ARCD\'s Relief responding?',
      body3:
          'Your generosity powers ARCD’s Relief food aid Projects, where each donation transcends empathy to provide sustenance, erasing the shadows of hunger. Join us and witness the profound impact of your support—illuminating lives and forging a path toward a future free from hunger.',
    ...
    ProjectsData(
      ...
      title: 'Health Carer',
      description:
          'Your donation isn’t just a contribution; it’s a lifeline that fortifies communities and bolsters healthcare systems. Let’s transform hope into action, ensuring every individual in Africa receives the quality healthcare they rightfully deserve.',
      image:
          'https://africa-relief.org/wp-content/uploads/2023/11/image-2-2.webp',
      body1:
          'Africa bears over 24% of the world’s disease burden but has access to a mere 3% of health workers and less than 1% of global financial resources, according to WHO. This staggering gap in healthcare resources across numerous African nations raises a red flag for the continent’s overall health status, highlighting the urgent need for equitable support and resources.',
      header1:
          'Let\'s turn hope into action, ensuring every individual in Africa has the fundamental right to clean water for a healthier, empowered future.',
      body2:
          'Africa Relief implements two critical emergency strategies to safeguard the public health system from collapse. Our efforts focus on hospital rehabilitation and the vital distribution of medicine, medical supplies, and equipment, ensuring sustained support for communities in need.',
      header2: 'How is ARCD\'s Relief responding?',
      body3:
          'Supplying essential medical resources and equipment, ensuring continuous support for communities in need.',
    ...
    ProjectsData(
      ...
      description:
          'In the past, hearts were filled with care for orphans, embracing them with love. Today, their numbers have grown, and many who could have aided them are gone. Orphanhood, once uncommon, now prevails. The few remaining struggle to provide, unable to meet the rising tide of need.',
      image:
          'https://africa-relief.org/wp-content/uploads/2023/11/unnamed_1-1.webp',
      body1:
          'By sponsoring an orphan, you become their beacon of hope, offering stability, education, and a chance for a promising future. empowering orphans is not just a duty; it’s a pathway to a brighter, hopeful tomorrow',
      header1:
          'Your support changes lives, turning vulnerabilities into opportunities',
      body2:
          'ARCD’s Relief is dedicated to securing a better future for orphans. Through our Sponsorship Program, we provide access to education, healthcare, and a nurturing environment for these deserving children.',
      header2: 'How is ARCD\'s Relief responding?',
      body3:
          'Your donation directly impacts an orphan’s life, providing essentials like education, healthcare, and emotional support. Your generosity fosters resilience and empowers them to thrive despite challenges.',
      header3: 'Your donation nurturing Futures',
      amounts: [50, 150, 300, 600],
    ),
    ProjectsData(
      id: 6,
      type: 'Zakat',
      title: 'Zakat Al-Mal',
      description:
          'Zakat Al-Mal embodies the spirit of generosity, providing essential aid to uplift lives and communities',
      image:
          'https://africa-relief.org/wp-content/uploads/2023/11/image_15.webp',
      body1:
          'Contribute Zakat Al-Mal to create a ripple of positive change. Your generosity creates opportunities and transforms lives for the better.',
      header1:
          'Your Zakat extends a hand of hope, laying the groundwork for prosperity among those seeking aid.',
      body2:
          'ARCD’s Relief diligently allocates Zakat Al-Mal funds to support various sustainable projects, enabling long-term growth within communities.',
      header2: 'How is ARCD\'s Relief responding?',
      body3:
          'Your Zakat Al-Mal donation aids in education, healthcare, and economic empowerment, fostering stability and growth for underprivileged communities.',
    ...
    ProjectsData(
      ...
      title: 'Iftar Meal',
      description:
          'It’s more than just a meal, Having the Iftar meal together fosters unity and kindness, creating bonds that transcend hunger.',
      image:
          'https://africa-relief.org/wp-content/uploads/2023/11/image-6.webp',
      body1:
          'In the moments of having Iftar, we find unity and compassion. Join us in providing nourishment to those fasting, sowing seeds of solidarity and care.',
      header1:
          'Your support during Iftar extends beyond a meal; it feeds hope and strengthens communities.',
      body2:
          'ARCD’s Relief ensures that no one breaks their fast alone. Through our Iftar Meal project, we’re distributing nutritious meals to families, fostering a sense of togetherness during this sacred time.',
      header2: 'How is ARCD\'s Relief responding?',
      body3:
          'Your donation directly supports families in need, ensuring they have access to wholesome meals during Ramadan. Your generosity fosters a sense of community and provides nourishment when it’s needed most.',
      header3: 'Sharing an Iftar Meal, Enhancing Unity.',
      amounts: [30, 900, 300, 900],
    ),
  ];
  List<ProjectsData> blogs = [
    ProjectsData(
      ...
      body1:
          'In regions where access to quality education is a challenge, the establishment of an 8-room school equipped with a water well becomes a beacon of hope. This project not only provides a comprehensive educational setting for the community but also ensures students have access to clean water, a basic necessity often taken for granted. During the opening, the joy was palpable as donors interacted with the eager children and gifted school bags.',
      body2: 'Over 300 students.',
      header1:
          'Empower a child’s future through education and health. Your support can light up their world.',
    ...
    ProjectsData(
      ...
      body1:
          'In regions affected by water scarcity, every drop counts. These solar water wells, dedicated in honor of Mariame Diawara and Fatoumata Tiemoko, ensure that hundreds have access to clean, safe water. Beyond hydration, these wells represent hope, health, and a tribute to beloved individuals.',
      body2: '600-800 individuals.',
      header1:
          'Sun and water are the essence of life. Illuminate lives with your support.',
      header2: 'Beneficiaries:',
    ),
    ProjectsData(
      id: 4,
  ...
  void GetRetrieveAllPayments() {
    ...
    DioHelper.getData(
            url: '/payment-method/retrieve/all', token: 'Bearer $token')
        .then((value) {
  ...
  void SubscriptionDonation({required String comment}) {
    ...
    DioHelperLogin.postData(
      ...
      if (subscriptionPayment!.success == false&&subscriptionPayment!.data!.requiresAction==true) {
        ...
        emit(GetSubscriptionStatSuccess());
      }
    }).catchError((error) {
      print(error.toString());
  ...
  //   DioHelper.postData(
  //       url: '/subscription/create',
  //       data: {'paymentIntentId': otpID}).then((value) {
  ...
  void GetPaymentMethodId(
      String controller,
      String controllerexmonth,
      String controllerexyear,
      String controllerccv,
      String controllerName,
      String controllerMail,
      String controllerCountry,
      String controllerLine,
      String controllerCity,
      String controllerZip) {
    ...
    Stripea.Stripe.instance.api.createPaymentMethod({
      ...
      paymentMethodeID = value['id'].toString();
      print(paymentMethodeID);
      ...
      // //   DioHelperLogin.postData(url: '/payment-method/save', data: {
      // //   'paymentMethodId':paymentMethodeID,
      // // }).then((value) {
